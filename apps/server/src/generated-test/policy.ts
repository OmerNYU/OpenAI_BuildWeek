...
export const generatedTestCapabilities: readonly GeneratedTestCapability[] = [
  ...
  ...["getByAltText", "getByLabel", "getByPlaceholder", "getByRole", "getByTestId", "getByText", "getByTitle", "locator"].map((method) => ({ receiver: "page" as const, method, arguments: "value" as const, result: "locator" as const, minimumArguments: 1, maximumArguments: method === "getByRole" ? 2 : 1 })),
